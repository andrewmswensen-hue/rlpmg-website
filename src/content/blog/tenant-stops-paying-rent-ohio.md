...
slug: "tenant-stops-paying-rent-ohio"
wpId: 16882
heroImage: "https://rlpmg.com/wp-content/uploads/2026/08/Tenant-stops-paying-rent-blog-featured-image.png"
categories:
  - "Uncategorized"
---

*![Columbus, Ohio rental property with overcast skies](https://rlpmg.com/wp-content/uploads/2026/08/Tenant-stops-paying-rent-blog-featured-image-300x167.png)The rent didn’t arrive on the 1st. It’s now the 6th, the grace period is gone, and the tenant isn’t answering texts. What you do over the next 30 days determines whether this costs you a late fee or a five-figure loss.*
...
- The 3-day notice required by [ORC 1923.04](https://codes.ohio.gov/ohio-revised-code/section-1923.04) is a legal prerequisite to filing. Skipping it, or getting the wording wrong, restarts the clock.
...
- Self-help eviction (changing locks, shutting off utilities) is illegal in Ohio and exposes the owner to damages plus the tenant’s attorney fees under [ORC 5321.15](https://codes.ohio.gov/ohio-revised-code/section-5321.15).
...
One more thing the notice is not: permission to act on your own. Ohio law flatly prohibits self-help. Shutting off utilities, changing locks, removing belongings, or threatening any of it makes the owner liable for the tenant’s damages and attorney fees under [ORC 5321.15](https://codes.ohio.gov/ohio-revised-code/section-5321.15) (as of August 2026). The process is the only lawful path.

## Day 30+: What Does Filing an Eviction in Franklin County Involve?

If the notice period passes without resolution, the next step is filing a forcible entry and detainer action under [ORC Chapter 1923](https://codes.ohio.gov/ohio-revised-code/chapter-1923). For Columbus-area properties, that means [Franklin County Municipal Court](https://www.fcmcclerk.com/).
...
|---|---|
| Court filing fee, possession only ([FCMC fee schedule](https://www.fcmcclerk.com/documents/civil/civilcost.pdf), as of Aug 2026) | $149 |
...
- **Move-out inspection and deposit processing.** Condition is documented, and the security deposit is applied and itemized within Ohio’s 30-day window under [ORC 5321.16](https://codes.ohio.gov/ohio-revised-code/section-5321.16). The [security deposit rules guide](/blog/security-deposit-rules-ohio-landlord/) covers what can be deducted.
...
No. Lockouts, utility shutoffs, and removing belongings are prohibited by [ORC 5321.15](https://codes.ohio.gov/ohio-revised-code/section-5321.15), and violations make the owner liable for damages plus attorney fees (as of August 2026).
