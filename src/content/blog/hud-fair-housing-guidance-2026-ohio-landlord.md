...
slug: "hud-fair-housing-guidance-2026-ohio-landlord"
wpId: 16640
heroImage: "https://rlpmg.com/wp-content/uploads/2026/04/Featured-image-of-withdrawn-HUD-document.png"
categories:
  - "Fair Housing"
  - "Owner Education"
...
*![HUD document stamped withdrawn](https://rlpmg.com/wp-content/uploads/2026/04/Featured-image-of-withdrawn-HUD-document-300x169.png)HUD just pulled the playbook that landlords and property managers have relied on for years. But the law it was built on hasn’t moved an inch. Here’s what Ohio landlords need to understand right now.*
...
1. [What HUD Actually Withdrew (and When)](#what-withdrew)
2. [What This Means for Ohio Landlords Right Now](#ohio-impact)
3. [The Bottom Line: What Should You Actually Do?](#what-to-do)
4. [Frequently Asked Questions](#faq)

## What HUD Actually Withdrew (and When)

On April 3, 2026, HUD’s Office of Fair Housing and Equal Opportunity (FHEO) [pre-published a Federal Register notice](https://www.nahro.org/news/hud-withdraws-eight-fair-housing-notices/) withdrawing eight guidance documents from active use. The [formal notice appeared in the Federal Register on April 6, 2026](https://www.federalregister.gov/documents/2026/04/06/2026-06624/notification-of-withdrawal-of-fair-housing-and-equal-opportunity-guidance-documents), though the effective date of the withdrawal was September 17, 2025.
...
HUD stated that these documents were “sub-regulatory guidance, not binding law” and should no longer be relied upon as authoritative. The agency also noted that [if any guidance is deemed necessary after further review, it may be reissued](https://www.nahro.org/news/hud-withdraws-eight-fair-housing-notices/). Handbooks and internal training materials referencing these documents are being revised.
...
As [Navigate Housing noted in its analysis](https://www.navigatehousing.com/fair-housing-guidance-withdrawal-what-huds-2026-notice-means-for-housing-providers/), housing providers should shift from a guidance-based mindset to a statute-based mindset. The practical obligations haven’t disappeared; the agency’s how-to manual has.

Here’s what this means for the three areas Ohio landlords care about most:

**Criminal history screening.** The 2022 guidance requiring individualized assessment of criminal records is withdrawn. But blanket criminal history bans still carry significant legal risk. [Greystar settled a fair housing complaint in January 2026](https://calcivilrights.ca.gov/2026/01/13/major-property-management-company-to-review-and-revise-tenant-screening-policies-statewide-after-fair-housing-complaint/) over automatic rejections based on criminal history, and that case was driven by state law and private litigation (not HUD guidance). The safest approach remains individualized assessment: consider the nature and severity of the offense, how long ago it occurred, and its relevance to tenancy.
...
Beyond these specific areas, [HUD has separately proposed rescinding its disparate impact regulation entirely](https://www.spencerfane.com/insight/hud-moves-to-dismantle-its-disparate-impact-framework-under-the-fair-housing-act/). That proposed rule (published January 14, 2026) would eliminate HUD’s regulatory framework for evaluating whether a housing practice has an unjustified discriminatory effect. If finalized, disparate impact claims would be left to the courts to develop. This signals a broader shift: HUD is [moving away from being an enforcement-driven how-to manual](https://federalnewsnetwork.com/agency-oversight/2026/04/huds-first%E2%80%91year-reset-on-fair%E2%80%91housing-guidance-is-reshaping-federal-housing-rules/) and toward a narrower focus on cases involving clear, intentional discrimination.
...
**Remember that private lawsuits remain fully available.** HUD’s own withdrawal notice states that [complainants may still file civil actions in federal or state court within two years](https://www.navigatehousing.com/fair-housing-guidance-withdrawal-what-huds-2026-notice-means-for-housing-providers/) of an alleged discriminatory practice. Reduced HUD enforcement activity does not mean reduced legal exposure. State and local fair housing laws (including [Columbus’s 12 protected classes](https://www.columbus.gov/Government/Mayors-Office/City-Boards-Commissions-Committees/Community-Relations-Commission/Discrimination-Protected-Classes-in-Columbus) and Ohio’s additional protections for ancestry and military status) operate independently of federal guidance.
...
RLPM monitors regulatory changes, applies consistent screening criteria, and handles accommodation requests so you don’t have to navigate this yourself.
...
- [Federal News Network](https://federalnewsnetwork.com/agency-oversight/2026/04/huds-first%E2%80%91year-reset-on-fair%E2%80%91housing-guidance-is-reshaping-federal-housing-rules/), HUD’s First-Year Reset on Fair Housing Guidance (April 2026)
