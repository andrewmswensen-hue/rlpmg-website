...
slug: "columbus-summer-ac-storm-lawn-prep"
wpId: 16800
heroImage: "https://rlpmg.com/wp-content/uploads/2026/06/RLPM-BLOG-summer-maintenance.png"
categories:
  - "Investing Strategy"
  - "Owner Education"
...
*![Exterior photo of a Columbus rental property and A/C unit with storm clouds looming overhead.](https://rlpmg.com/wp-content/uploads/2026/06/RLPM-BLOG-summer-maintenance-300x167.png)Central Ohio’s first heat advisory of the season landed in late June, with heat index values pushing past 100 degrees, and a round of severe storms already swept the region earlier in the month. Here’s what Columbus landlords should have locked down before the next heat wave or downburst hits.*
...
1. [Why This Summer Is Testing Columbus Rentals](#why-this-summer)
2. [The Real Reason AC Systems Fail in July](#why-ac-fails)
3. [Preventing the Failure Before It Happens](#prevent-failure)
4. [What Ohio Law Actually Requires on AC](#ohio-ac-law)
5. [A Same-Day Response Checklist When the AC Goes Out](#ac-failure-checklist)
6. [Storms, Power Outages, and What They Knock Out](#storms-power-outages)
7. [The Lawn Code Doesn’t Pause for a Vacancy](#lawn-code-compliance)
8. [Building a Summer That Doesn’t Need Emergency Calls](#building-predictable-summer)
9. [Frequently Asked Questions](#faq)

## Why This Summer Is Testing Columbus Rentals

Central Ohio’s first major heat event of 2026 arrived in late June, when the [National Weather Service issued a heat advisory](https://www.10tv.com/weather/alerts) for Columbus and the surrounding region with heat index values reaching the mid-100s. A heat dome settled over Ohio at the same time, pushing daytime highs into the low-to-mid 90s with humidity dragging the heat index even higher, prompting a [statewide safety alert from Governor Mike DeWine’s office](https://www.wosu.org/2026-06-29/safety-alert-issued-for-ohio-as-heat-dome-impacts-the-state). Add a [severe thunderstorm watch covering Franklin County and the surrounding area on June 6](https://www.weatherbug.com/alerts/columbus-oh-43211), with wind gusts capable of exceeding 75 mph, and summer 2026 is shaping up to be a stress test for Columbus rental housing.
...
Air conditioners rarely fail at random. Three issues account for most July breakdowns: clogged filters restricting airflow, dirty evaporator or condenser coils losing their ability to transfer heat, and refrigerant leaks that leave the system working harder for less cooling. [The Department of Energy traces most performance complaints back to these same three causes](https://www.energy.gov/energysaver/common-air-conditioner-problems). Each one develops slowly. A filter clogs over weeks, not days. A coil collects more debris each time pollen or cut grass blows past the unit. A small refrigerant leak doesn’t announce itself until the system can’t keep up with demand.
...
Here’s a distinction that surprises a lot of newer landlords: Ohio law doesn’t require a rental property to have air conditioning at all. Under [Ohio Revised Code 5321.04](https://codes.ohio.gov/ohio-revised-code/section-5321.04), landlords are required to provide reasonable heat, but air conditioning isn’t on that list.
...
Columbus’s code enforcement division actively enforces its weed and grass ordinance on rental properties. Under [Columbus City Code 709.03](http://columbus-oh.elaws.us/code/coor_title7_ch709_sec709.03), grass and weeds aren’t allowed to exceed 12 inches in height on any property in the city. Several surrounding suburbs set the bar lower; [Dublin, for example, enforces a 6-inch limit](https://dublinohiousa.gov/code-compliance/) on vacant and undeveloped property from March through October. The practical range most Central Ohio landlords should plan around is roughly 6 to 12 inches, depending on the municipality.
